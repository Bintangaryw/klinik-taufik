...
<head>
    ...
    <title>Klinik Taufik | List Perjanjian</title>
</head>
                                                    ...
                                                    @foreach ($perjanjians as $perjanjian)
                                                        <tr class="border-b border-neutral-200 dark:border-white/10">
                                                            ...
                                                            <td class="whitespace-nowrap  px-6 py-4 flex ">
                                                                <form class="px-2"
                                                                    action="{{ route('perjanjian.batal', $perjanjian['id']) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    <button
                                                                        class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Batalkan
                                                                    </button>
                                                                </form>
                                                                <form
                                                                    action="{{ route('perjanjian.selesai', $perjanjian['id']) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    <button
                                                                        class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Selesai
                                                                    </button>
                                                                </form>
                                                            </td>
                                                        </tr>
