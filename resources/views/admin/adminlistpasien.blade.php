...
<head>
    ...
    <title>Klinik Taufik | Admin List Pasien</title>
</head>
    ...
    <div class="min-h-full">
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">Daftar Pasien Klinik Gigi Drg. Taufik</h1>
            </div>
        </header>
        ...
        <main>
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                ...
                <div>
                    <div class="mt-3 ml-3 sm:ml-0">
                        <a href="/adminregisterpasien">
                            <button type="submit"
                                                    ...
                                                    <tbody class="  text-black">
                                                        @foreach ($pasiens as $pasien)
                                                            <tr
                                                                ...
                                                                <td class="whitespace-nowrap  px-6 py-4">
                                                                    {{ $pasien['nomor_telepon'] }}</td>
                                                                <td class="whitespace-nowrap  px-6 py-4">
                                                                    <a href="/admindetailpasien/{{ $pasien->id }}">
                                                                        <button type="submit"
                                                                    ...
                                                                    <a
                                                                        href="/admintambahperjanjian/{{ $pasien->id }}">
                                                                        <button type="submit"
                                                                            class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Buatkan
                                                                            Perjanjian
                                                                        </button>
                                                                    </a>
                                                                </td>
