    ...
    <div class="min-h-full">
        ...
        <main>
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                <form action="{{ route('rekam_medis.submitByDokter') }}" method="post" class="mx-4 sm:mx-0">
                    @csrf
                                            ...
                                            <div class="mt-4">
                                                <div
                                                    ...
                                                    <input type="date" name="tanggal_pemeriksaan"
                                                        id="tanggal_pemeriksaan" autocomplete="off" required
                                        ...
                                        <div class="col-span-full">
                                            <div class="mt-2">
                                                <textarea id="rk_1" name="rk_1" rows="3"
                                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 px-3 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="sm:col-span-4 py-3 mt-3">
